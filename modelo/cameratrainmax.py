...
DATA_YAML = "data_yolo2/data.yaml"

PROJECT = "camera_birds_tfg"
RUN_NAME = "yolo12m_23species_dobleetapa"
...
LOG_PATH = f"logs/train_23species_{timestamp}.log"
...
# =========================================================
# ETAPA A — GENERALIZACIÓN (23 clases)
# =========================================================
...
# =========================================================
# ETAPA B — FINE TUNE (SGD) (23 clases)
# =========================================================
...
# =========================================================
# EVALUACIÓN FINAL (VAL normal + VAL con TTA)
# =========================================================

def final_eval(weights, device, imgsz_eval):
    log("\n=== EVALUACIÓN FINAL (VAL) ===")
...
if __name__ == "__main__":
    try:
        ...
        log("=== YOLO12m 23-ESPECIES DOBLE ETAPA ===")
        log(f"LOG: {LOG_PATH}")
        log(f"DATA_YAML: {DATA_YAML}")
        log(f"RUN: {PROJECT}/{RUN_NAME}")

        best_a = stage_a(device, workers)
        best_final = stage_b(best_a, device, workers)

        final_eval(best_final, device, imgsz_eval=IMG_SIZE_B)

        log("\nENTRENAMIENTO COMPLETADO")
        log(f"MODELO FINAL: {best_final}")
        log("TensorBoard: tensorboard --logdir <carpeta_del_run>")
